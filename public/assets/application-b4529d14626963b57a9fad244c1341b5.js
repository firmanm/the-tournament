...
(function() {
  $(function() {
    var addCountryFlg, createBracket, getQueryString, hideDecimal, prepareImage, resizeBracket;
    if (($('#tournament').length)) {
      ...
      resizeBracket = function() {
        var bracket_width, round_num, size_diff;
        ...
        if (score_width !== DEFAULT_SCORE_WIDTH) {
          return $('#tournament .score').width(score_width);
        }
      };
