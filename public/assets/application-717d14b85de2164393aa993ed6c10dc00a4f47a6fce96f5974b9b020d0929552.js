...
(function() {
  $(document).on('turbolinks:load', function() {
    var createBracket, edit_fn, hideDecimal, prepareImage, render_fn, setTooltip;
        ...
        return jQuery.each($('.score'), function() {
          if (!isNaN(this.innerText)) {
            if (gon.scoreless) {
              ...
              return this.innerText = Math.abs(Math.floor(this.innerText));
            }
          }
        });
      };
      setTooltip = function() {
        return $('.bracket .teamContainer').each(function(i) {
          return $(this).attr({
